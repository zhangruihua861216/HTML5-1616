...
(function (global, setTimeout) {
    ...
    function newContext(contextName) {
        ...
        function normalize(name, baseName, applyMap) {
            ...
            if (name) {
                ...
                // If wanting nodeday1 ID compatibility, strip .js from end
                // of IDs. Have to do this here, and not in nameToUrl
                // because nodeday1 allows either .js or non .js to map
                // to same file.
                ...
                if (!this.inited) {
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(factory)) {
                            ...
                            // Favor return value over exports. If nodeday1/cjs in play,
        ...
        /**
         * Given an event from a script nodeday1, get the requirejs info from it,
         * and then removes the event listeners on the nodeday1.
         * @param {Event} evt
         * @returns {Object}
         */
        ...
        context = {
            ...
            onScriptLoad: function (evt) {
                ...
                if (evt.type === 'load' ||
                    ...
                    //Reset interactive script so a script nodeday1 is not held onto for
                    //to long.
    ...
    /**
     * Creates the nodeday1 for the load command. Only used in browser envs.
     */
    ...
    req.load = function (context, moduleName, url) {
        ...
        if (isBrowser) {
            ...
            if (node.attachEvent &&
                    //Check if nodeday1.attachEvent is artificially added by custom script or
                    //natively supported by browser
                    //read https://github.com/requirejs/requirejs/issues/187
                    //if we can NOT find [native code] then it must NOT natively supported.
                    //in IE8, nodeday1.attachEvent does not have toString()
                ...
                //nodeday1.attachEvent('onerror', context.onScriptError);
            } else {
            ...
            //Calling onNodeCreated after all properties on the nodeday1 have been
            ...
            //call to the module name (which is stored on the nodeday1), hold on
            //to a reference to this nodeday1, but clear after the DOM insertion.
