...
test('async foo', function (t) {
    ...
    resolve('foo', { basedir : dir }, function (err) {
        t.equal(err.message, "Cannot find modules 'foo' from '" + path.resolve(dir) + "'");
    });
});
...
test('cup', function (t) {
    ...
    function (err, res) {
        t.equal(err.message, "Cannot find modules './cup' from '" + path.resolve(dir) + "'");
    });
});
...
test('other path', function (t) {
    ...
    resolve('root', { basedir : dir, }, function (err, res) {
        t.equal(err.message, "Cannot find modules 'root' from '" + path.resolve(dir) + "'");
    });
    
    resolve('zzz', { basedir : dir, paths: [otherDir] }, function (err, res) {
        t.equal(err.message, "Cannot find modules 'zzz' from '" + path.resolve(dir) + "'");
    });
});
